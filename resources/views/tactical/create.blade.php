...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div style="padding:10px"></div>
            <button type="button" id="changeRed">RED</button>
            <button type="button" id="changeBlue">BLUE</button>
            <button type="button" id="changeBlack">BLACK</button>
        </div>
        <div style="padding:10px"></div>
            <button type="button" id="resetBtn">リセット</button>
            <button type="button" id="prevBtn">戻る</button>
            <button type="button" id="nextBtn">進む</button>
        </div>
        <div style="padding:10px">
            <button type="button" id="changeImg" value="1">画像変換</button>
        </div>
        <h2>画像出力<h2> 
